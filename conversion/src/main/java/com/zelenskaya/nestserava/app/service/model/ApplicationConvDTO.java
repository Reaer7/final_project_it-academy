...
import static com.zelenskaya.nestserava.app.service.model.ServiceConstants.FULL_NAME_INDIVIDUAL;
import static com.zelenskaya.nestserava.app.service.model.ServiceConstants.ID;
import static com.zelenskaya.nestserava.app.service.model.ServiceConstants.MAX_SIZE_NAME_EMPLOYEE;
import static com.zelenskaya.nestserava.app.service.model.ServiceConstants.MAX_SIZE_NAME_LEGAL;
import static com.zelenskaya.nestserava.app.service.model.ServiceConstants.MAX_SIZE_UUID;
...
import static com.zelenskaya.nestserava.app.service.model.ServiceConstants.PERCENT_CONV;
import static com.zelenskaya.nestserava.app.service.model.ServiceConstants.STATUS;
import static com.zelenskaya.nestserava.app.service.model.ServiceConstants.VALUE_IND;
import static com.zelenskaya.nestserava.app.service.model.ServiceConstants.VALUE_LEG;
